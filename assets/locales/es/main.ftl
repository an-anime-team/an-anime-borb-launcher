...
loading-launcher-state--components = Cargando estado del launcher: comprobando componentes
...
install-mfc140 = Instalar mfc140
install-fonts = Instalar tipografías
update = Actualizar
download = Descargar
