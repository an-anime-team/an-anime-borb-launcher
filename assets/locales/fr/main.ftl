...
loading-launcher-state--components = État du chargement du launcher : vérification des composants
...
install-mfc140 = Installer mfc140
install-fonts = Installer les polices d'écriture
