...
loading-launcher-state--components = Launcher status wird geladen: Überprüfung der Komponenten
...
install-mfc140 = Installiere mfc140
install-fonts = Installiere fonts
update = Updaten
